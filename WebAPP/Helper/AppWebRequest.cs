...
namespace WebAPP.Helper
{
    public class AppWebRequest: IAppWebRequest
    {
        ...
        #region HttpPost
        public async Task<WebAPP.Models.HttpResponse> PostAsync(string URL, string PostData = "", string AccessToken = "", string ContentType = "application/json", int timeout = 0)
        {
            WebAPP.Models.HttpResponse httpResponse = new WebAPP.Models.HttpResponse();
